...
def plot_and_save_sensors(input_dir, output_dir):
    ...
    for file_name in os.listdir(input_dir):
        if file_name.startswith('train') and file_name.endswith('.csv'):
            # Read the CSV file
            ...
            for sensor_name in sensor_names:
                plot_sensor(sensor_name, train, base_filename)

# Example usage
input_dir = '/home/ubuntu/Project7008/data/Processed'
output_dir = '/home/ubuntu/Project7008/data/Figures/Train'
